function init_state(){
    const f8 = new Float32Array([0.4524833858013153, -2.007500648498535, -0.08623051643371582, 3.1803951263427734, 3.669093132019043, 2.328918933868408, -1.5484731197357178, 1.3885247707366943]);
...
function unnormalizeTensor(t){
    const mu_diff = [ 0.0028, -0.0032,  0.0002,  0.0027,  0.0047, -0.0007, -0.0014,  0.0023];
    const sigma_diff = [0.6590, 0.6301, 0.4959, 0.6799, 1.0076, 0.6527, 0.4810, 0.7263];
    let f8 = new Float32Array(8);
    for(let i = 0; i < 16; i++){
