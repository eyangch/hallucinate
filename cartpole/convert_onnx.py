...
model_ae = models.load_ae("model_ae_8_interp.torch")
model_lstm = models.load_lstm_onnx("model_lstm_8_interp.torch")
model_ae.eval()
model_lstm.eval()

example_encoder_inputs = (torch.randn(1, 3, 192, 192),)
example_decoder_inputs = (torch.randn(1, 8),)
example_lstm_inputs = (
    torch.randn(1, 1, 9), 
    torch.zeros(3, 1, 128),
    torch.zeros(3, 1, 128)
